...
use aui::nav::{
    rail, sidebar, MetaItem, RailItem, SessionSummary, SidebarAccount, SidebarGroup, SidebarNav, SidebarNavItem,
};
...
fn sample_nav() -> SidebarNav {
    SidebarNav::new(
        "acme",
        SidebarAccount::new("B", "Bharani \u{b7} Max", Provider::Claude, 0.78),
    )
