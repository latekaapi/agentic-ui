...
pub static ENTRIES: &[Entry] = &[
    ...
    Entry {
        ...
        group: "Sidebar",
        title: "Sidebar views",
        subtitle: "Three groupings of the same sessions: by status, by project with nested sessions, by date with a pinned group; the view-options menu; and the project grouping at 240 and 520 px",
        width: 1180.0,
        height: 1046.0,
        theme: CardTheme::Dark,
