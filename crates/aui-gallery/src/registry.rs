...
pub static ENTRIES: &[Entry] = &[
    ...
    Entry {
        ...
        group: "Sidebar",
        title: "Sidebar views",
        subtitle: "Three groupings of the same sessions: by status, by project with nested sessions, by date with a pinned group; the view-options menu; the project grouping at 240 and 520 px; the second line's four states at 300 px; and option B at 260 and 420 px with the hover detail's three states",
        width: 1180.0,
        height: 2220.0,
        theme: CardTheme::Dark,
    ...
    Entry {
        id: "transcript/host-actions",
        group: "Transcript",
        title: "Host actions",
        subtitle: "The L5 host hooks: a tool card with a trailing action, and a fenced block with its run-this header action",
        width: 760.0,
        height: 560.0,
        theme: CardTheme::Dark,
        build: crate::cards::host_actions::build,
    },
    Entry {
    ...
    #[cfg(feature = "tui")]
    Entry {
        id: "workbench/terminal-blocks",
        group: "Workbench",
        title: "Terminal grid with blocks",
        subtitle: "The alacritty-backed grid with the block overlay: nonce-checked OSC 133 marks assembled into blocks with status, duration and exit",
        width: 980.0,
        height: 720.0,
        theme: CardTheme::Dark,
        build: crate::cards::terminal_blocks::build,
    },
    Entry {
        id: "workbench/terminal-dock",
        group: "Workbench",
        title: "Terminal dock",
        subtitle: "The dock frame with its tab strip as the host mounts it: three tabs, the agent's running, over the block terminal",
        width: 980.0,
        height: 720.0,
        theme: CardTheme::Dark,
        build: crate::cards::terminal_dock_card::build,
    },
    Entry {
